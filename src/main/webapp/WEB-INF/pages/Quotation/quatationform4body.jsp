...
<form role="form" name="fname"  id="fname"  action="saveQuotationDetail.html" method="post">
<div class="form-horizontal">
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="container-fluid header-padding">
					<div class="row-fluid">
						<div class="span10" align="left">Quotation For Another Item</div>
				...
				<div class="row-fluid search-align">
					<div class="firstquad">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="form-control" readonly="readonly"   id="custName" name="custName" value="${custName}"class="search" />
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">Item Code</label>
							<div class="controls">
								<select class="form-control" id="itemCode" name="itemCode" class="form-control">
								<option>--Select--</option>
											<c:if test="${not empty itemcodelst}">
             		           					<c:forEach var="listValue" items="${itemcodelst}">
					...
					<div class="firstquad">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="form-control" name="qdate" id="qdate" value="${qdate}" placeholder="" />
							</div>
						</div>
