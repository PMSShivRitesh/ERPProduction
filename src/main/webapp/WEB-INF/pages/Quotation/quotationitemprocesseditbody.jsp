		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="container-fluid header-padding">
					<div class="row-fluid">
						<div class="span9" align="left">Edit Item Process 
						
							
							</div>
						<div class="span3" align="right">
							<!-- <button class="btn-save" title="Save" onclick="createUser();" id="btnsave"></button> -->
							<input type="submit" class="btn-save" value="" id="btnsave" title="Add Item Process"/>
							...
							<div class="btn" align="right" title="Next Form" onclick="getNextForm()" title="Go to Quotation Detail" >
							<i class="icon-forward"></i>
							<!--  	<input type="button" class="glyphicon glyphicon-step-backward" value="Next" onclick="getNextForm()"/>-->
							</div>
							
							<div class="btn" align="left" title="Go To Quotation Systems" onclick="gethomepage()" >
							<i class="icon-home"></i>
							<!--  	<input type="button" class="glyphicon glyphicon-step-backward" value="Next" onclick="getNextForm()"/>-->
							</div>
						</div>
...
<input type="hidden" value="${custName}" name="custName" id="custName">
								<input type="hidden" value="${itemCode}" name="itemCode" id="itemCode">
									...
									<input type="hidden" value="quotationitemprocesseditform" name="fnm" id="fnm">
			<!--      Actual Form -->
