...
<form role="form" action="gateDistrictListByState.html" name="fnm">
				...
				<div class="container-fluid header-padding">
					<div class="row-fluid">
						...
						<div class="span2" align="right">
							<div class="btn" onclick="addDistrict()"  title="Add State">
				...
				<div class="row-fluid search-align">
					...
					<div class="firstquad">
						...
						<div class="control-group">
							...
							<div class="controls">
								<select class="form-control" name="stateId" id="stateName" onchange="this.form.submit()"></select>
...
function addDistrict(){
	location.href="CommanDistrictInputRequest.html"
}
