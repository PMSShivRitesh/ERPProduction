...
<form role="form" action="getTalukaList.html" name="fnm">
				...
				<div class="container-fluid header-padding">
					<div class="row-fluid">
						...
						<div class="span2" align="right">
							...
							<div class="btn" onclick="addTaluka()"  title="Add State">
			...
			<div class="container-fluid panel-body">
				...
				<div class="firstquad">
						...
						<div class="control-group">
							...
							<div class="controls">
								<select class="form-control" name="districtId" id="districtName" required="required" onchange="this.form.submit()">
											<option></option>
										</select>
							</div>
...
function addTaluka(){
	location.href="CommanTalukaInputRequest.html"
}
