...
<form role="form" action="saveModule.html">
<div class="form-horizontal">
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="container-fluid header-padding">
					<div class="row-fluid">
						<div class="span10" align="left">System Module</div>
						<div class="span2" align="right">
							<input type="submit" class="btn-save" value="" id="btnsave" title="Add Module"/>
							
							
								<div class="btn" align="left" title="Admin Home" onclick="gethomepage()" >
							<i class="icon-home"></i>
				...
				<div class="row-fluid search-align">
					<div class="firstquad">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="moduleName" required="required" class="form-control" placeholder="" />
							</div>
						</div>
					...
					<div class="firstquad">
						...
						<div class="control-group">
							<label class="control-label">Module Desc</label>
							<div class="controls">
								<input type="text" name="moduleDesc" required="required" class="form-control" placeholder="" />
							</div>
						</div>
			...
			<div class="panel-heading">
				<div class="container-fluid header-padding">
					<div class="row-fluid">
						<div class="span11" align="left">Available Module </div>
